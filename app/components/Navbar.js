...
function Navbar() {
  ...
  return (
    <header>
      <nav className="bg-[#23232B] text-[#DEDEDE] flex justify-between items-center px-7 md:justify-evenly py-7">
        <div className="text-4xl w-32 h-14 font-black">
          <Image src="/logo.png" alt="Logo" width={123} height={54} />
        </div>
        <div className="hidden md:flex xl:gap-7 gap-3 lg:text-xl xl:text-2xl">
        ...
        <div className="hidden md:flex">
          <button className="bg-[#AAFF30] w-40 xl:w-48 lg:w-44 h-11 rounded-3xl text-[#23232B] lg:text-xl xl:text-2xl font-black">
            Get Started
          </button>
        </div>
        <div className="md:hidden flex" id="menu">
          <Image
            src="/menu.svg"
            alt="Menu"
            width={50}
